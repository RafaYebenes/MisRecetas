package com.example.zafiro2.misrecetas.Dialogos;
...
import java.util.Calendar;
    ...
    public class DialogoFecha extends DialogFragment implements DatePickerDialog.OnDateSetListener {
        ...
        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
            TextInputEditText txieFecha = (TextInputEditText)getActivity().findViewById(R.id.eddFechaNacimientoPerfil);
            txieFecha.setText(transDatos(dayOfMonth)+"-" + transDatos(month+1)+"-"+transDatos(year)
            );
        }
